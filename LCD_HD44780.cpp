...
void LCD_HD44780::init(void) {
	...
	LCD_HD44780::writeCommand(HD44780_DISPLAY_ONOFF | HD44780_DISPLAY_OFF); // wy≥πczenie wyswietlacza
	LCD_HD44780::writeCommand(HD44780_CLEAR); // czyszczenie zawartosÊi pamieci DDRAM
	_delay_ms(2);
	LCD_HD44780::writeCommand(
	...
	LCD_HD44780::writeCommand(
			HD44780_DISPLAY_ONOFF | HD44780_DISPLAY_ON | HD44780_CURSOR_OFF
					| HD44780_CURSOR_NOBLINK); // w≥πcz LCD, bez kursora i mrugania
}
...
void LCD_HD44780::showNumberDouble(double liczba){
	LCD_HD44780::clear();
	char text[32];

	sprintf(text, "%.6g", liczba);
	LCD_HD44780::writeText(text);
}
